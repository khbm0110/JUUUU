    ...
    [Language.FR]: {
      ...
      contact: {
        ...
        appointmentModal: {
          ...
          weekendWarning: 'Les rendez-vous ne sont pas disponibles le week-end. Veuillez sélectionner un jour de semaine.',
    ...
    [Language.EN]: {
      ...
      contact: {
        ...
        appointmentModal: {
          ...
          weekendWarning: 'Appointments are not available on weekends. Please select a weekday.',
    ...
    [Language.AR]: {
      ...
      contact: {
        ...
        appointmentModal: {
          ...
          weekendWarning: 'المواعيد غير متاحة في عطلة نهاية الأسبوع. الرجاء تحديد يوم من أيام الأسبوع.',
